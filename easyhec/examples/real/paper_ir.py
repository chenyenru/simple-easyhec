...
#     try:
#         # prefer registering the sam2 package if importable
#         initialize_config_module("sam2", version_base="1.2")
#     except Exception:
#         # fallback: register configs dir relative to this file
#         # cfg_dir = str(
...
#         #     / "configs"
#         # )
#         # print(f"Hydra sam2 config module not found, registering from {cfg_dir}")
